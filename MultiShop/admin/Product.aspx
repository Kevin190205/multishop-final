<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="MultiShop.admin.Product1" %>
...
<asp:Content ID="Content6" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
                                    ...
                                    <asp:Repeater ID="UserRepeater" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("Id") %></td>
                                                <td>
                                                    <img src='data:image/jpeg;base64,<%# Convert.ToBase64String((byte[])Eval("Product_image")) %>' alt="Product Image" style="max-width: 60px; max-height: 70px;" />
                                                </td>
                                                <td><%# Eval("Product_name") %></td>
                                                <td><%# Eval("Price") %></td>
                                                <td><%# Eval("Del_Price") %></td>
                                                <td>
                                                     <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" CommandArgument='<%# Eval("Id") %>' CssClass="delete">Delete</asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
    ...
    <div class="popup-content">
        ...
        <div class="modal-footer">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="btn btn-primary">Submit</asp:LinkButton>
        </div>
    </div>
</div>
